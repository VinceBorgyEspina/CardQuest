...
class Command (BaseCommand):
    ...
    def create_pokemon_cards(self):
        ...
        card1 = PokemonCard(name="Pikachu", rarity="Rare",hp=60, cardtype="Electric", attack="Thunder Shock",
                    ...
                    abilities="Static")
        card2 = PokemonCard(name= "Charmeleon", rarity= "Rare",hp= 120, cardtype= "Fire", attack= "Flamethrower", 
                            description= "It has a barbaric nature. In battle, it whips its fiery tail around and slashes away with sharp claws.", 
                            weakness= "Water",card_number= 5,release_date= "1996-02-27", evolution_stage= "Stage 2", abilities= "Solar Power")
        card3 = PokemonCard(name= "Mewtwo", rarity= "Uncommon",hp=  150, cardtype= "Psychic", attack= "Psychic",
        ...
        card4 = PokemonCard(name= "Caterpie", rarity= "Common",hp= 45, cardtype= "Grass", attack= "Bug Bite", 
        ...
        card5 = PokemonCard(name= "Squirtle", rarity= "Rare",hp= 40, cardtype= "Water",attack=  "Bubble", 
        ...
        card6 = PokemonCard(name= "Eevee",rarity= "Rare", hp= 50, cardtype= "Normal", attack= "Tackle", 
        ...
        card7 = PokemonCard(name="Snorlax",rarity= "Uncommon",hp= 140,cardtype= "Normal",attack= "Body Slam", 
        ...
        card8 = PokemonCard(name="Raikou",rarity= "Rare", hp= 90,cardtype= "Electric",attack= "Thunder Fang",
        ...
        card9 = PokemonCard(name="Cryogonal",rarity= "Rare",hp= 80,cardtype= "Ice",attack= "Aurora Beam",
        ...
        card10 = PokemonCard(name="Pancham",rarity= "Uncommon",hp= 67,cardtype= "Fighting",attack= "Circle Throw",
        ...
        card11 = PokemonCard(name="Entei",rarity= "Rare",hp= 115,cardtype= "Fire",attack= "Flame Wheel",
        ...
        card12 = PokemonCard(name="Suicune",rarity= "Rare",hp= 100,cardtype= "Water",attack= "Hydro Pump",
        ...
        card13 = PokemonCard(name="Mudkip",rarity= "Common",hp= 50,cardtype= "Water",attack= "Watergun",
        ...
        card14 = PokemonCard(name="Meowth",rarity= "Rare",hp= 40,cardtype= "Normmal",attack= "Fake out",
        ...
        card15 = PokemonCard(name="Jigglypuf",rarity= "Rare",hp= 115,cardtype= "Fairy",attack= "Disarming Voice",
        ...
        card16 = PokemonCard(name="Duskull",rarity= "Common",hp= 20,cardtype= "Ghost",attack= "Payback",
        ...
        card17 = PokemonCard(name="Wobbuffet",rarity= "Rare",hp= 190,cardtype= "Pyschic",attack= "Destiny Bond",
        ...
        card18 = PokemonCard(name="Darkrai",rarity= "Rare",hp= 70,cardtype= "Dark",attack= "Dark Pulse",
        ...
        card19 = PokemonCard(name= "Totodile",rarity= "Common",hp= 50,cardtype= "Water",attack= "Water Gun",
        ...
        card20 = PokemonCard(name= "Deoxys",rarity= "Rare",hp= 50,cardtype= "Pyschic",attack= "Cosmic Power",
